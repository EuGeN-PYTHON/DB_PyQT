...
class AugeasLexer(RegexLexer):
    ...
    tokens = {
        'root': [
            ...
            (r'(del|store|value|counter|seq|key|label|autoload|incl|excl|transform|unit_tests|get|put)(\s+)', bygroups(Name.Builtin, Whitespace)),
...
class SingularityLexer(RegexLexer):
    ...
    _section = r'^(%(?:pre|post|setup|environment|help|labels|unit_tests|runscript|files|startscript))(\s*)'
    _appsect = r'^(%app(?:install|help|run|labels|env|unit_tests|files))(\s*)'
