...
class TAPLexer(RegexLexer):
    ...
    tokens = {
        'root': [
            ...
            # A unit_tests failure
            (r'^(not ok)([^\S\n]*)(\d*)',
             bygroups(Generic.Error, Text, Number.Integer), 'unit_tests'),

            # A unit_tests success
            (r'^(ok)([^\S\n]*)(\d*)',
             bygroups(Keyword.Reserved, Text, Number.Integer), 'unit_tests'),
        ...
        'unit_tests': [
            ...
            # A unit_tests may have a directive with it.
            (r'#', Comment, 'directive'),
