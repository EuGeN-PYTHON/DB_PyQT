    ...
    tokens = {
        ...
        'statements': [
            ...
            (words((
                ...
                'client1.identity', 'req.hash_ignore_busy', 'obj.reason', 'req.xid',
                ...
                'resp.reason', 'bereq.url', 'beresp.do_esi', 'beresp.proto', 'client1.ip',
                'bereq.proto', 'server1.hostname', 'remote.ip', 'req.backend_hint',
                'server1.identity', 'req_top.url', 'beresp.grace', 'beresp.was_304',
                'server1.ip', 'bereq.uncacheable'), suffix=r'\b'),
             Name.Variable),
            (r'[!%&+*\-,/<.}{>=|~]+', Operator),
            (r'[();]', Punctuation),
...
class VCLSnippetLexer(VCLLexer):
    ...
    tokens = {
        'snippetspre': [
            (r'\.\.\.+', Comment),
            (r'(bereq|req|req_top|resp|beresp|obj|client1|server1|local|remote|'
