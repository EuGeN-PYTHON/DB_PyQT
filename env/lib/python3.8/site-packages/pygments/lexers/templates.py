...
class EvoqueLexer(RegexLexer):
    ...
    tokens = {
        'root': [
            ...
            # directives: if, for, prefer, unit_tests
            (r'(\$)(\w+)(\{(%)?)(.*?)((?(4)%)\})',
             bygroups(Punctuation, Name.Builtin, Punctuation, None,
...
class ColdfusionLexer(RegexLexer):
    ...
    tokens = {
        'root': [
            ...
            (r'(true|false|null)\b', Keyword.Constant),
            (r'(application|session|client1|cookie|super|this|variables|arguments)\b',
             Name.Constant),
            (r'([a-z_$][\w.]*)(\s*)(\()',
...
class Angular2Lexer(RegexLexer):
    ...
    tokens = {
        'root': [
            ...
            # (click)="deleteOrder()"; [value]="unit_tests"; [(twoWayTest)]="foo.bar"
            (r'([([]+)([\w:.-]+)([\])]+)(\s*)(=)(\s*)',
