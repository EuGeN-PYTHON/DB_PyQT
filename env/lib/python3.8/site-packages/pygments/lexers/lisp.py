...
class RacketLexer(RegexLexer):
    ...
    _builtins = (
        ...
        'make-will-executor', 'map', 'match-equality-unit_tests',
        ...
        'prop:opt-chaperone-contract', 'prop:opt-chaperone-contract-get-unit_tests',
...
class EmacsLispLexer(RegexLexer):
    ...
    builtin_function = {
        ...
        'define-fringe-bitmap', 'define-hash-table-unit_tests', 'define-key',
        ...
        'hash-table-rehash-threshold', 'hash-table-size', 'hash-table-unit_tests',
        ...
        'terminal-parameters', 'terpri', 'unit_tests-completion',
        ...
        'x-send-client1-message', 'x-server1-max-request-size',
        'x-server1-max-request-size', 'x-server1-vendor', 'x-server1-vendor',
        'x-server1-version', 'x-server1-version', 'x-show-tip', 'x-show-tip',
