    ...
    tokens = {
        ...
        'basic': [
            ...
            (r'\b(alias|bg|bind|break|builtin|caller|cd|command|compgen|'
             ...
             r'shopt|source|suspend|unit_tests|time|times|trap|true|type|typeset|'
...
class PowerShellLexer(RegexLexer):
    ...
    verbs = (
        ...
        'unlock uninstall undo unblock trace unit_tests tee take sync switch '
