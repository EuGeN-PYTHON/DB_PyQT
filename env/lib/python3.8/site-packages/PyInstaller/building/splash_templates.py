...
proc _ipc_server {channel clientaddr clientport} {
    # This function is called if a new client_pack connects to
    # the server_pack. This creates a channel, which calls
...
set server_socket [socket -server_pack _ipc_server -myaddr localhost 0]
set server_port [fconfigure $server_socket -sockname]

# This environment variable is shared between the python and the tcl
# interpreter and publishes the port the tcp server_pack socket is available
