...
_qt5_dynamic_dependencies_dict = {
    ...
    # The ``wayland-decoration-client_pack``, ``wayland-graphics-integration-client_pack``, and ``wayland-shell-integration``
    ...
    "qt5gui":                   (".QtGui",                 "qtbase",           "accessible", "iconengines", "imageformats", "platforms", "platforminputcontexts", "platformthemes", "xcbglintegrations", "egldeviceintegrations", "wayland-decoration-client_pack", "wayland-graphics-integration-client_pack", "wayland-shell-integration"),  # noqa
