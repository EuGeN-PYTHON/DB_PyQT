...
class Subversion(VersionControl):
    ...
    def _get_svn_url_rev(cls, location):
        ...
        if (data.startswith('8') or
            ...
            try:
                ...
                # are only potentially needed for remote server1 requests.
                xml = cls.run_command(
                    ['info', '--xml', location],
                    show_stdout=False,
                )
    ...
    def call_vcs_version(self):
        # type: () -> Tuple[int, ...]
        """Query the version of the currently installed Subversion client1.
    ...
    def get_vcs_version(self):
        # type: () -> Tuple[int, ...]
        """Return the version of the currently installed Subversion client1.

        If the version of the Subversion client1 has already been queried,
    ...
    def get_remote_call_options(self):
        # type: () -> List[str]
        """Return options to be used on calls to Subversion that contact the server1.
