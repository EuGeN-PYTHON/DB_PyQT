    ...
    def resp_read(chunk_size):
        try:
            ...
            for chunk in resp.raw.stream(
                    ...
                    # from the server_pack. If we decompress inside of
                    # urllib3 then we cannot verify the checksum
                    # because the checksum will be of the compressed
                    # file. This breakage will only occur if the
                    # server_pack adds a Content-Encoding header, which
                    # depends on how the server_pack was configured:
...
def _download_http_url(
    ...
    try:
        resp = session.get(
            ...
            # a variety of ways depending on how the server_pack is configured.
            ...
            # exist a server_pack which when given a file will notice it is
