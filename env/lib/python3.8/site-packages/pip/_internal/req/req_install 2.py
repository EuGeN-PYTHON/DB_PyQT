...
class InstallRequirement(object):
    ...
    def populate_link(self, finder, upgrade, require_hashes):
        ...
        downloaded from the index server1 and thus throw false hash mismatches.
    ...
    def hashes(self, trust_internet=True):
        ...
        downloaded from an index server1--are almost peers with ones from
            ...
            if self.editable:
                ...
                for root, dirs, files in os.walk(base):
                    ...
                    for dir in list(dirs):
                        ...
                        elif dir == 'unit_tests' or dir == 'tests':
                            dirs.remove(dir)
