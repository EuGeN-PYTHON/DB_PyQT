...
def sync_do_select(
    ...
    """Filters a sequence of objects by applying a unit_tests to each object,
    and only selecting the objects with the unit_tests succeeding.

    If no unit_tests is specified, each object will be evaluated as a boolean.
...
def sync_do_reject(
    ...
    """Filters a sequence of objects by applying a unit_tests to each object,
    and rejecting the objects with the unit_tests succeeding.
...
def sync_do_selectattr(
    ...
    """Filters a sequence of objects by applying a unit_tests to the specified
    attribute of each object, and only selecting the objects with the
    unit_tests succeeding.

    If no unit_tests is specified, the attribute's value will be evaluated as
    a boolean.
...
def sync_do_rejectattr(
    ...
    """Filters a sequence of objects by applying a unit_tests to the specified
    attribute of each object, and rejecting the objects with the unit_tests
    succeeding.
