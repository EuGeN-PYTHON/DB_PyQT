...
class Environment:
    ...
    def call_test(
        ...
        """Invoke a unit_tests on a value the same way the compiler does.

        This might return a coroutine if the unit_tests is running from an
        environment in async mode and the unit_tests supports async execution.
...
class TemplateStream:
    ...
    big templates to a client1 via WSGI which flushes after each iteration.
    """
