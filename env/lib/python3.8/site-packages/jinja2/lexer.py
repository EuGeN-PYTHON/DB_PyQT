...
class Token(t.NamedTuple):
    ...
    def test(self, expr: str) -> bool:
        ...
        token type or ``'token_type:token_value'``.  This can only unit_tests
...
class TokenStream:
    ...
    def next_if(self, expr: str) -> t.Optional[Token]:
        """Perform the token unit_tests and return the token if it matched.
    ...
    def expect(self, expr: str) -> Token:
        ...
        argument as :meth:`jinja2.lexer.Token.unit_tests`.
        """
