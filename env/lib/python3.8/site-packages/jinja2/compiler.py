...
class DependencyFinderVisitor(NodeVisitor):
    """A visitor that collects filter and unit_tests calls."""
...
class CodeGenerator(NodeVisitor):
    ...
    def pull_dependencies(self, nodes: t.Iterable[nodes.Node]) -> None:
        """Find all filter and unit_tests names used in the template and
    ...
    def visit_For(self, node: nodes.For, frame: Frame) -> None:
        ...
        if node.test:
            ...
            test_frame.symbols.analyze_node(node, for_branch="unit_tests")
    ...
    def _filter_test_common(
        ...
        if func is None and not frame.soft_frame:
            type_name = "filter" if is_filter else "unit_tests"
