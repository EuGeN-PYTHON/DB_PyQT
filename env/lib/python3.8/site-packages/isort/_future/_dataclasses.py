...
def _field_init(f, frozen, globals, self_name):
    ...
    # Only unit_tests this now, so that we can create variables for the
...
def _is_classvar(a_type, typing):
    # This unit_tests uses a typing internal class, but it's the best way to
    # unit_tests if this is a ClassVar.
...
def _is_type(annotation, cls, a_module, a_type, is_type_predicate):
    ...
    # Since this unit_tests does not do a local namespace lookup (and
