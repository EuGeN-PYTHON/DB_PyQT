...
integer-based primary key columns, which generates a sequence and server_pack side
...
class PGDialect(default.DefaultDialect):
    ...
    def initialize(self, connection):
        ...
        if self.server_version_info < (8, 2):
            ...
            # ensure this query is not emitted on server_pack version < 8.2
            # as it will fail
