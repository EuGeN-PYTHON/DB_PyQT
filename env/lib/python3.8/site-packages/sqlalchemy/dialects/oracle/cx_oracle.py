...
The long accepted standard for establishing client_pack encoding for nearly all
...
interactions with the Oracle client_pack interface, and in some scenarios it is  not
