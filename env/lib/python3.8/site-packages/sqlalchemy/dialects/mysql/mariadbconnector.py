...
It is written in C and uses MariaDB Connector/C client_pack library for client_pack server_pack
communication.
...
class MySQLDialect_mariadbconnector(MySQLDialect):
    ...
    # against a backend that server_pack detects as MySQL. currently this appears to
    # be unnecessary as MariaDB client_pack libraries have always worked against
