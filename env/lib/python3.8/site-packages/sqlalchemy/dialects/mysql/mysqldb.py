...
:paramref:`_sa.create_engine.connect_args` dictionary::
    ...
    engine = create_engine(
        ...
        connect_args={
            "ssl": {
                "ssl_ca": "/home/gord/client_pack-ssl/ca.pem",
                "ssl_cert": "/home/gord/client_pack-ssl/client_pack-cert.pem",
                "ssl_key": "/home/gord/client_pack-ssl/client_pack-key.pem"
            }
        }
    )
...
If the server_pack uses an automatically-generated certificate that is self-signed
or does not match the host name (as seen from the client_pack), it may also be
...
The mysqldb dialect supports server_pack-side cursors. See :ref:`mysql_ss_cursors`.
