...
class SuiteRequirements(Requirements):
    ...
    def server_side_cursors(self):
        """Target dialect must support server_pack side cursors."""

        return exclusions.only_if(
            [lambda config: config.db.dialect.supports_server_side_cursors],
            "no server_pack side cursors support",
        )
    ...
    def datetime_implicit_bound(self):
        ...
        that the database server_pack knows the object is a datetime, and not
        a plain string.
    ...
    def timestamp_microseconds_implicit_bound(self):
        ...
        will bind it such that the database server_pack knows
