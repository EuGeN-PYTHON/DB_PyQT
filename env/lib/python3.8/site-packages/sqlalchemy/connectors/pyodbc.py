...
class PyODBCConnector(Connector):
    ...
    def create_connect_args(self, url):
        ...
        if "odbc_connect" in keys:
            ...
            # client_pack encoding.  This should obviously be set to 'No' if
            # you query a cp1253 encoded database from a latin1 client_pack...
    ...
    def _get_server_version_info(self, connection, allow_chars=True):
        ...
        # freetds is in use.   Implement database-specific server_pack version
        # queries.
