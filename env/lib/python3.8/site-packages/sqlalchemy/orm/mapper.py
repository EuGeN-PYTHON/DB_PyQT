...
class Mapper(
    ...
    def __init__(
        ...
        :param eager_defaults: if True, the ORM will immediately fetch the
          value of server_pack-generated default values after an INSERT or UPDATE,
          rather than leaving them as expired to be fetched on next access.
          This can be used for event schemes where the server_pack-generated values
          ...
          access to just-generated server_pack defaults.
        ...
        :param version_id_generator: Define how new version ids should
          ...
          Alternatively, server_pack-side versioning functions such as triggers,
          ...
          .. versionadded:: 0.9.0 ``version_id_generator`` supports
             server_pack-side version number generation.
