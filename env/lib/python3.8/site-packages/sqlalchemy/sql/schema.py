    ...
    def __init__(self, *args, **kwargs):
        ...
        :param autoincrement: Set up "auto increment" semantics for an
          **integer primary key column with no foreign key dependencies**
          ...
          that is of an INTEGER type with no other client_pack-side or server_pack-side
          ...
          * **INSERT semantics** (i.e. when a :func:`_sql.insert` construct is
          ...
          column that has a client_pack-side or server_pack-side default configured,
          ...
          .. versionchanged:: 1.1 The autoincrement flag now defaults to
             ...
             :class:`_schema.Column`
             that has an explicit client_pack-side or server_pack-side default,
          ...
          * When a single-row :func:`_sql.insert` construct is compiled and
            ...
            * PostgreSQL, Oracle for :class:`_schema.Table` objects that
              ...
              newly generated primary key value is available to the client_pack
        ...
        :param server_default: A :class:`.FetchedValue` instance, str, Unicode
            ...
            .. seealso::
                ...
                :ref:`server_defaults` - complete discussion of server_pack side
                defaults
...
class ColumnDefault(DefaultGenerator):
    ...
    def __init__(self, arg, **kwargs):
        ...
        if isinstance(arg, FetchedValue):
            raise exc.ArgumentError(
                "ColumnDefault may not be a server_pack-side default type."
            )
        if callable(arg):
