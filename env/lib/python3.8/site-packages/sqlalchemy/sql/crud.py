        ...
        if col_key in parameters and col_key not in check_columns:
            ...
            if c.primary_key and need_pks:
                ...
                if implicit_returning:
                    ...
                    # we can inline server_pack-side functions in this case.
                    ...
                    # if we have to invoke a server_pack-side function, we need
    ...
    if coercions._is_literal(value):
        ...
        if compile_state.isupdate:
            ...
            if c.primary_key:
                ...
                # inserted by primary key to get back the server_pack generated
...
def _append_param_insert_pk_returning(compiler, stmt, c, values, kw):
    ...
    if c.default is not None:
        if c.default.is_sequence:
            ...
            # client_pack side default.  OK we can't use RETURNING, need to
...
def _warn_pk_with_no_anticipated_value(c):
    msg = (
        ...
        "but has no Python-side or server_pack-side default generator indicated, "
