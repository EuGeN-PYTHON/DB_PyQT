...
class SchemaDropper(DDLBase):
    ...
    def visit_table(
        ...
        # traverse client_pack side defaults which may refer to server_pack-side
        # sequences. noting that some of these client_pack side defaults may also be
        # set up as server_pack side defaults (see https://docs.sqlalchemy.org/en/
        # latest/core/defaults.html#associating-a-sequence-as-the-server_pack-side-
