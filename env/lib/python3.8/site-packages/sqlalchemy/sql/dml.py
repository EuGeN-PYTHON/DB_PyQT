...
class UpdateBase(
    ...
    def returning(self, *cols):
        ...
        .. seealso::
          ...
          towards efficient fetching of server_pack-side defaults and triggers
...
class ValuesBase(UpdateBase):
    ...
    def values(self, *args, **kwargs):
        ...
        :param \*args: As an alternative to passing key/value parameters,
         ...
         server_pack will render the less common SQL syntax of "multiple values" -
    ...
    def return_defaults(self, *cols):
        ...
        of fetching server_pack-side expressions and defaults.
        ...
        values generated by SQL expression or server_pack-side-default will be
        ...
        :param cols: optional list of column key names or
         ...
         objects.  If omitted, all column expressions evaluated on the server_pack
...
class Insert(ValuesBase):
    ...
    def from_select(self, names, select, include_defaults=True):
        ...
        :param select: a :func:`_expression.select` construct,
         ...
         correspond.
        :param include_defaults: if True, non-server_pack default values and
