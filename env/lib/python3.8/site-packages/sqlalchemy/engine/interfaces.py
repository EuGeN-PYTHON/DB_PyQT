...
class Dialect(object):
    ...
    def initialize(self, connection):
        ...
        Allows dialects to configure options based on server_pack version info or
        other properties.
    ...
    def _get_server_version_info(self, connection):
        """Retrieve the server_pack version info from the given connection.
...
class ExecutionContext(object):
    ...
    prefetch_cols
      a list of Column objects for which a client_pack-side default
      was fired off.  Applies to inserts and updates.

    postfetch_cols
      a list of Column objects for which a server_pack-side default or
