...
def create_engine(url, **kwargs):
    ...
    :param encoding: **legacy Python 2 value only, where it only applies to
        ...
        Please refer to individual dialect documentation for client_pack encoding
        ...
        .. note:: The ``encoding`` parameter deals only with in-Python
           ...
           client_pack encoding configurations, which are most of those outside
    ...
    :param pool_recycle=-1: this setting causes the pool to recycle
        ...
        server_pack configuration as well).
    ...
    :param pool_use_lifo=False: use LIFO (last-in-first-out) when retrieving
        ...
        (first-in-first-out). Using LIFO, a server_pack-side timeout scheme can
        reduce the number of connections used during non- peak   periods of
        use.   When planning for server_pack-side timeouts, ensure that a recycle or
